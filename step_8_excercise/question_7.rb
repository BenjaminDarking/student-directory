...
# ask user which cohort they will be in
      while true do
        ...
        months = ["january", "february", "march", "april", "may", "june", "july",
          "august", "septemebr", "october", "november", "december"]
...
def print_header
  puts "The Students of Villans Academy".center(30)
  puts "---------------".center(30)
end
...
def print(students)
  counter = 0
   while counter < students.size do
    puts "#{students[counter][:name]}(#{students[counter][:cohort]} cohort)".center(30)
    counter += 1
   end
end
